...
namespace BrainFuckInterpreter
{
    ...
    public class InterpreterUTF
    {
        public delegate void BFEvent(string msg, int codePos, int dataPos, uint dataValue);
        ...
        bool stop = false;
        public InterpreterUTF(string code, string input)
        {
